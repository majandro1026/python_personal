...
class Calculadora(tk.Tk):
    def __init__(self) -> None:
        ...
        # caja de texto(input)
        self.entrada = None
        # StringVar lo utilizamos para obtener el valor dle input
    ...
    def _creacion_componentes(self):
        ...
        entrada_frame = tk.Frame(self, width=350, height=50, background='grey')
        ...
        botones_frame = tk.Frame(self, width=350, height=450, background='grey')
        botones_frame.pack()

        # Primer renglon
        boton_clear = tk.Button(botones_frame, text='C', width=32, height=3, bd=0, bg='#eee', cursor='hand2', 
                            command=self._evento_clear)
        boton_clear.grid(row=0, column=0, columnspan=3, padx=1, pady=1)

        #boton division

        boton_division = tk.Button(botones_frame, text='/', width=10, height=3, bd=0, bg='#eee', cursor='hand2', 
        ...
        boton_multiplicar = tk.Button(botones_frame, text='*', width=10, height=3, bd=0, bg='#eee', cursor='hand2', command=lambda: self._evento_click('*'))
        ...
        boton_resta= tk.Button(botones_frame, text='-', width=10, height=3, bd=0, bg='#eee', cursor='hand2', command=lambda: self._evento_click('-'))
        ...
        boton_suma= tk.Button(botones_frame, text='+', width=10, height=3, bd=0, bg='#eee', cursor='hand2', command=lambda: self._evento_click('+'))
        boton_suma.grid(row=3, column=3, padx=1, pady=1)

        # quinto renglon

        boton_cero = tk.Button(botones_frame, text='0', width=21, height=3, bd=0, bg='#fff', cursor='hand2', command=lambda: self._evento_click(0))
    ...
    def _evento_evaluar(self):
        #eval evalua la expresion str como una expresion aritmética
        try:
            if self.expresion: #### para evidar el levantamienot de un error cuando solo se presiona el boton '='
